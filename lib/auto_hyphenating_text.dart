...
class AutoHyphenatingText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int? getLastSyllableIndex(List<String> syllables, double availableSpace,
      ...
      if (getTextWidth(mergeSyllablesFront(syllables, 0), effectiveTextStyle,
      ...
      while (lowerBound != upperBound - 1) {
        ...
        if (getTextWidth(mergeSyllablesFront(syllables, testIndex),
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        for (var line in userLines) {
          ...
          if (lineWords.isNotEmpty) {
            ...
            // if (lineWords.any((element) => element.isNotEmpty)) {
            // }
          }
